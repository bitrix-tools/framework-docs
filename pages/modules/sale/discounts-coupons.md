...
Если товарная цена должна учитывать права пользователя, диапазонные цены и купоны на уровне каталога, используйте API каталога. Подробнее в разделе [Торговый каталог](./../catalog/_index.md).
