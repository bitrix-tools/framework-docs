...
3. Выберите, кому показывать панель.
   ...
   -  В параметре *Всегда показывать панель для пользователей* укажите нужных пользователей или группы.
      ...
      ![](./_images/admin-panel-8.png){width=750px height=441px}
...
![](./_images/admin-panel-6.png){width=1258px height=179px}
...
![](./_images/admin-panel.jpeg){width=1280px height=133px}
...
![](./_images/admin-panel-11.png){width=1258px height=179px}
...
![](./_images/admin-panel-9.png){width=1081px height=210px}

Если во включаемой области размещен файл с компонентом, например строка поиска или ссылки на социальные сети:

1. Нажмите ![](./_images/admin-panel-2.png){width=31px height=34px} > *Редактировать параметры компонента*.

2. Внесите изменения и нажмите *Сохранить*.

![](./_images/admin-panel-3.png){width=417px height=155px}
...
![](./_images/admin-panel-4.png){width=1237px height=334px}
...
![](./_images/admin-panel-5.png){width=398px height=624px}

### Редактирование шаблона

Чтобы отредактировать шаблон сайта выберите *Шаблон сайта > В панели управления > Редактировать шаблон.*

![](./_images/admin-panel-12.png){width=1199px height=279px}
