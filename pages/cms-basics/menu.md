...
![](./_images/menu.png){width=700px height=300px}
...
![](./_images/menu-2.png){width=700px height=347px}
...
![](./_images/menu-3.png){width=700px height=303px}
...
![](./_images/menu-31.png){width=700px height=113px}
...
![](./_images/menu-32.png){width=700px height=395px}
...
![](./_images/menu-33.png){width=700px height=590px}
...
![](./_images/menu-34.png){width=670px height=274px}
...
![](./_images/menu-36.png){width=700px height=577px}
...
![](./_images/menu-35.png){width=700px height=279px}
...
![](./_images/menu-9.png){width=611px height=346px}
...
2. Отметьте опцию *добавить пункт меню*.
   ...
   ![](./_images/menu-11.png){width=597px height=377px}

3. Укажите имя пункта и выберите тип `Левое меню`.

   ![](./_images/menu-12.png){width=597px height=377px}

Система создаст раздел и добавит пункт в Левое меню.

![](./_images/menu-20.png){width=527px height=258px}
...
![](./_images/menu-24.png){width=549px height=212px}
...
2. В разделе `test-menu` создайте папку `test-1` и добавьте ее в меню типа `[submenu] Подменю`. Дополнительно можно создать индексную страницу раздела.
   ...
   ![](./_images/menu-15.png){width=675px height=485px}

3. Внутри `test-1` создайте папку `test-2` и добавьте ее в меню типа `[submenu] Подменю`.

   ![](./_images/menu-16.png){width=673px height=485px}
...
4. Файл с меню будет создан автоматически в `test-1` вместе с папкой `test-2`. Это происходит за счет того, что для папки `test-2` была отмечена опция Создать пункт меню.
   ...
   ![](./_images/menu-17.png){width=616px height=304px}
...
5. В папке `test-2` создайте меню типа `[submenu] Подменю` и добавьте пункт со ссылкой, например, на индексную страницу.
   ...
   ![](./_images/menu-18.png){width=681px height=307px}

В результате меню будет отображено как дерево из четырех уровней.

![](./_images/menu-13.png){width=606px height=231px}
...
![](./_images/menu-14.png){width=689px height=217px}
...
5. В разделе `test-menu` создайте файл `.submenu.menu_ext.php`. Имя типа `submenu` должно совпадать с типом меню в разделе.
   ...
   ![](./_images/menu-22.png){width=700px height=424px}
...
12. В нижней части раздела откройте параметры компонента Меню `bitrix:menu`.
    ...
    ![](./_images/menu-19.png){width=657px height=211px}

13. Отметьте опцию *Подключать файлы с именами вида .тип\_меню.menu_ext.php*.

    ![](./_images/menu-23.png){width=733px height=485px}
...
![](./_images/menu-25.png){width=700px height=310px}
...
1. Подготовьте три изображения.
   ...
   ![](./_images/menu-26.png){width=700px height=76px}
...
3. Создайте папку `menu` и загрузите в нее картинки.
   ...
   ![](./_images/menu-27.png){width=567px height=278px}
...
6. Для пунктов меню добавьте параметры:
   ...
   ![](./_images/menu-28.png){width=700px height=470px}
...
10. Скопируйте шаблон компонента и откройте его на редактирование.
    ...
    ![](./_images/menu-29.png){width=650px height=197px}
...
![](./_images/menu-30.png){width=651px height=274px}
...
![](./_images/menu-4.png){width=719px height=471px}
