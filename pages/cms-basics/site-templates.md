...
Скриншот шаблона можно сохранить в файле `screen.gif` и разместить в папке шаблона. В результате скриншот отобразится в строке шаблона на странице *Настройки > Настройки продукта > Сайты > Шаблоны сайтов*.
...
-  Храните изображения пользовательского шаблона в папке `images`. Вы избежите путаницы с изображениями других шаблонов и компонентов. 
