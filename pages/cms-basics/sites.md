...
2. Файловая структура:
   ...
   -  пользовательские доработки в `/local/`, код инициализации для конкретного сайта — в `/local/php_interface/<ID сайта>/init.php`.
...
![](./_images/sites-2.png){width=750px height=441px}
...
![](./_images/sites.png){width=750px height=440px}
