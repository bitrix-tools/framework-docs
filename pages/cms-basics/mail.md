...
2. На вкладке Настройки задайте параметры обработки и хранения писем.
   ...
   ![](./_images/mail-10.png){width=645px height=467px}
...
3. На вкладке SMTP-сервер укажите команду для запуска встроенного почтового сервера.
   ...
   ![](./_images/mail-11.png){width=630px height=321px}
...
2. Нажмите Добавить и выберите тип ящика.
   ...
   ![](./_images/mail.png){width=689px height=462px}
...
![](./_images/mail-2.png){width=576px height=700px}

На вкладке Дополнительные настройки укажите параметры получения сообщений.

![](./_images/mail-3.png){width=689px height=456px}
...
![](./_images/mail-4.png){width=683px height=634px}
...
2. Нажмите Добавить правило и выберите тип.
   ...
   ![](./_images/mail-5.png){width=703px height=437px}
...
3. Заполните поля на вкладке Параметры.
   ...
   ![](./_images/mail-6.png){width=666px height=511px}
...
5. На третьей вкладке настройте действия. Система применит их к письмам, которые соответствуют условиям правила.
   ...
   ![](./_images/mail-8.png){width=687px height=461px}
...
![](./_images/mail-14.png){width=700px height=660px}
...
![](./_images/mail-15.png){width=678px height=483px}
...
![](./_images/mail-16.png){width=679px height=351px}
...
![](./_images/mail-17.png){width=674px height=560px}
...
4. Введите имя хоста, для которого нужно настроить отправку почты.
   ...
   ![](./_images/mail-18.png){width=618px height=267px}
...
5. Укажите параметры.
   ...
   ![](./_images/mail-19.png){width=698px height=430px}
...
4. Отметьте язык системы и укажите:
   ...
   ![](./_images/mail-20.png){width=673px height=453px}
...
2. Настройте параметры шаблона.
   ...
   ![](./_images/mail-23.png){width=674px height=273px}
...
3. В блоке Поля письма задайте отправителя, получателей и тему письма. Чтобы увидеть все поля, нажмите «показать дополнительные заголовки...». При заполнении можно использовать [макросы](./mail#%D0%BC%D0%B0%D0%BA%D1%80%D0%BE%D1%81%D1%8B).
   ...
   ![](./_images/mail-24.png){width=524px height=202px}
...
2. Перетащите компонент из списка в рабочую область.
   ...
   ![](./_images/mail-27.png){width=700px height=542px}

3. В теле письма нажмите на компонент дважды.

4. Настройте параметры компонента.

   ![](./_images/mail-28.png){width=672px height=434px}
...
![](./_images/mail-29.png){width=700px height=568px}

Дальнейшие шаги повторяют создание шаблона сайта. Технически тема оформления — это шаблон сайта с типом `mail`. В файле `.description.php` должно быть:
...
?>
```
Если берете за основу шаблон штатной темы, скопируйте его из `/bitrix/templates/` в `/local/templates/` и отредактируйте копию.
