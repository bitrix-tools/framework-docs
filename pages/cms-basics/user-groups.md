...
![](./_images/user-groups.png){width=700px height=423px}
...
2. Выберите действие:
   ...
   ![](./_images/user-groups-18.png){width=668px height=366px}
...
![](./_images/user-groups-19.png){width=733px height=661px}
...
![](./_images/user-groups-20.png){width=635px height=640px}

### Вкладка Доступ

Настройте уровни прав доступа к модулям системы.

![](./_images/user-groups-21.png){width=626px height=291px}
...
8. Для группы Редакторы новостей установите право Чтение.
   ...
   ![](./_images/user-groups-24.png){width=729px height=472px}
...
10. На вкладке Доступ для группы Редакторы новостей установите право Изменение.
    ...
    ![](./_images/user-groups-25.png){width=700px height=463px}
...
12. В список *Всегда показывать панель для пользователей* добавьте группу Редакторы новостей.
    ...
    ![](./_images/user-groups-26.png){width=700px height=344px}
