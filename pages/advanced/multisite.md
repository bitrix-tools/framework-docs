...
Агенты в многосайтовой системе являются общими для всей установки. Они хранятся в единой базе данных и выполняются из единого списка, без автоматической фильтрации по текущему сайту. При проектировании агента не рассчитывайте, что он запустится отдельно для каждого сайта или получит контекст пользователя и сайта. Если логика должна учитывать сайты, передавайте нужный идентификатор сайта явно и обрабатывайте его внутри агента.
