...
![](./_images/two-factor-auth-1.png){width=750px height=270px}
...
1. HMAC-Based One-time Password, HOTP — по счетчику:
   ...
   -  количество действующих кодов ограничено параметром *Размер окна проверки паролей* в настройках двухэтапной авторизации.
      ...
      ![](./_images/two-factor-auth-2.png){width=682px height=520px}
...
3. Настройте параметры двухэтапной авторизации.
   ...
   ![](./_images/two-factor-auth-3.png){width=592px height=625px}
...
![](./_images/two-factor-auth-4.png){width=750px height=295px}
...
![](./_images/two-factor-auth-5.png){width=726px height=623px}
...
![](./_images/two-factor-auth-6.png){width=750px height=361px}
