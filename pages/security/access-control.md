...
![](./_images/access-control.png){width=1304px height=755px}
...
2. Заполните параметры формы.
   ...
   ![](./_images/access-control-2.png){width=700px height=520px}

3. На вкладке *Включаемые операции* выберите разрешенные действия.

   ![](./_images/access-control-3.png){width=663px height=533px}
...
1. Включите опцию *Расширенное управление правами* в настройках инфоблока.
   ...
   ![](./_images/access-control-6.png){width=685px height=568px}
...
1. **Через настройки группы пользователей**.
   ...
   -  Настройте права для каждого модуля на вкладке Доступ.
      ...
      ![](./_images/access-control-4.png){width=657px height=490px}
...
2. **Через настройки модуля**.
   ...
   -  Настройте права для групп на вкладке Доступ.
      ...
      ![](./_images/access-control-5.png){width=702px height=361px}
