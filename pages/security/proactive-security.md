...
![](./_images/proactive-security-42.png){width=669px height=888px}
...
![](./_images/proactive-security-2-2.png){width=750px height=494px}
...
![](./_images/proactive-security-3-2.png){width=678px height=409px}
...
![](./_images/proactive-security-5-2.png){width=580px height=48px}
...
![](./_images/proactive-security-6-2.png){width=751px height=504px}
...
![](./_images/proactive-security-4-2.png){width=660px height=466px}
...
![](./_images/proactive-security-11-2.png){width=734px height=388px}
...
![](./_images/proactive-security-16-2.png){width=594px height=382px}
...
![](./_images/proactive-security-18-2.png){width=679px height=348px}
...
![](./_images/proactive-security-19-2.png){width=698px height=356px}
...
![](./_images/proactive-security-17-2.png){width=740px height=311px}
...
![](./_images/proactive-security-20-2.png){width=694px height=618px}
...
![](./_images/proactive-security-21-2.png){width=762px height=536px}
...
![](./_images/proactive-security-22-2.png){width=681px height=466px}
...
![](./_images/proactive-security-23-2.png){width=600px height=656px}
...
![](./_images/proactive-security-34-2.png){width=682px height=308px}
...
5. Нажмите Далее. Если все введено правильно, вы увидите сообщение об успешном подписании скрипта.
   ...
   ![](./_images/proactive-security-24-2.png){width=653px height=515px}
...
2. Нажмите Далее.
   ...
   ![](./_images/proactive-security-25-2.png){width=653px height=235px}
...
4. Нажмите Далее.
   ...
   ![](./_images/proactive-security-27-2.png){width=655px height=383px}

5. Скачайте файл с данными на локальный компьютер.

   ![](./_images/proactive-security-26-2.png){width=655px height=254px}
...
4. Нажмите Далее.
   ...
   ![](./_images/proactive-security-28-2.png){width=652px height=236px}

5. Выберите лог-файл из системы или загрузите его с компьютера.

6. Нажмите Далее.

   ![](./_images/proactive-security-33-2.png){width=600px height=325px}
...
9. Нажмите Далее.
   ...
   ![](./_images/proactive-security-29-2.png){width=600px height=226px}

   Начнется процесс проверки, по окончании которого будет выведен отчет.

   ![](./_images/proactive-security-30-2.png){width=600px height=194px}
...
3. На вкладке Параметры укажите действие при обнаружении вируса и интервал оповещения.
   ...
   ![](./_images/proactive-security-31-2.png){width=700px height=303px}

4. Если веб-антивирус срабатывает на легитимный код, добавьте строку из этого кода в исключения.

   ![](./_images/proactive-security-32-2.png){width=698px height=323px}
...
![](./_images/proactive-security-39-2.png){width=750px height=364px}
...
![](./_images/proactive-security-40-2.png){width=750px height=503px}
...
![](./_images/proactive-security-41-2.png){width=750px height=498px}

### Примеры вредоносного кода

-  Выполнение произвольного кода.

   ![](./_images/proactive-security-10.png){width=750px height=58px}

   ![](./_images/proactive-security-9.png){width=750px height=60px}

   ![](./_images/proactive-security-8.png){width=750px height=98px}

   ![](./_images/proactive-security-7.png){width=750px height=117px}

   ![](./_images/proactive-security-6.png){width=750px height=116px}

   ![](./_images/proactive-security-5.png){width=750px height=196px}

   ![](./_images/proactive-security-4.png){width=750px height=498px}

-  Cоздание файла, через который впоследствии будет выполняться произвольный код.

   ![](./_images/proactive-security-3.png){width=750px height=79px}

-  Отправка спам-писем на произвольные адреса.

   ![](./_images/proactive-security-2.png){width=750px height=672px}

-  Авторизация под администратором без проверок пароля и двухфакторной авторизации.

   ![](./_images/proactive-security.png){width=750px height=98px}
...
![](./_images/proactive-security-8-2.png){width=617px height=711px}
...
![](./_images/proactive-security-7-2.png){width=716px height=483px}
