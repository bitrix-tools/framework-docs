...
![](./_images/firewall-2.png){width=726px height=539px}
...
![](./_images/firewall-3.png){width=750px height=294px}
...
3. Для нужных групп пользователей выберите уровень доступа `[F] Обход проактивного фильтра`.
   ...
   ![](./_images/firewall-1.png){width=680px height=361px}
...
![](./_images/firewall-4.png){width=617px height=711px}
