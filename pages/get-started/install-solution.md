...
После создания учетной записи администратора [в мастере установки](./install-distr.md) *1С-Битрикс: Управление сайтом* можно добавить готовое решение или завершить установку без него.
...
![](./_images/install-solution.png){width=740px height=623px}
...
Решения из Маркетплейс можно установить на сайты с действующей лицензией. Для демоверсии необходимо получить [пробный лицензионный ключ](./install-solution.md#activation).

#### Выбор решения

Выберите решение из каталога и нажмите Далее.

![](./_images/install-solution-2.png){width=740px height=630px}

#### Загрузка решения

Дождитесь завершения загрузки. Система автоматически запустит мастер настройки решения.

![](./_images/install-solution-3.png){width=600px height=163px}
