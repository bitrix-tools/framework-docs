...
![](./_images/create-page-10.png){width=543px height=314px}
...
1. Заполните основные параметры.
   ...
   ![](./_images/create-page-2.png){width=684px height=382px}
...
2. Настройте пункт меню, если включено на первом шаге мастера.
   ...
   ![](./_images/create-page-3.png){width=684px height=382px}
   ...
   ![](./_images/create-page.png){width=740px height=448px}
...
3. Настройте свойства страницы. Вы можете изменить значения, которые наследуются из раздела.
   ...
   ![](./_images/create-page-6.png){width=740px height=456px}
...
5. Если в мастере разрешен переход к редактированию, добавьте текст или компоненты на страницу.
   ...
   ![](./_images/create-page-7.png){width=740px height=479px}
...
2. Нажмите *Добавить > Добавить файл*.
   ...
   ![](./_images/create-page-5.png){width=685px height=393px}

3. Заполните поля в форме с настройками страницы. Они повторяют параметры из мастера [выше](./create-page.md#публичный-раздел).

4. Добавьте содержимое страницы с помощью редактора. Редактор можно сменить по кнопке Редактировать.

   ![](./_images/create-page-9.png){width=740px height=412px}
   ...
   ![](./_images/create-page-8.png){width=677px height=330px}
