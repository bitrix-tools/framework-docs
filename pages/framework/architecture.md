...
<iframe src="/pages/framework/_images/architecture.svg" width="100%" height="341px" style="border:none;"></iframe>
...
2. **Подготовка**. Система подключает `prolog_before.php` для инициализации фреймворка и сайта. Например, запускает автозагрузку классов, задает базовые константы, определяет язык. Подробнее в статье [Жизненный цикл запроса](./request-lifecycle.md).
...
![](./_images/architecture.png){width=885px height=919px}
...
![](./_images/architecture-2.png){width=657px height=904px}
