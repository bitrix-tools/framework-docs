...
**Пример.** Страница задает заголовок и добавляет кнопку в правую группу.
...
**Пример.** Панель получает заголовок с ограничением ширины и переносом на несколько строк.
...
**Пример.** Панель получает подзаголовок со временем обновления и счетчик у правого края.
...
**Пример.** Страница включает кнопку одним вызовом фасада.
...
**Пример.** Типовая страница списка собирает панель целиком.
...
**Пример.** Скрипт страницы получает кнопку по идентификатору и переводит ее в состояние ожидания.
...
**Пример.** Обработчик отправляет новый заголовок на сервер после завершения редактирования.
