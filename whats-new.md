...
-  Полностью обновили статью [Контроллеры](./pages/framework/controllers.html).
-  Описали как подменить ответ через фильтр в статье [Контроллеры](./pages/framework/pre-post-filters.html#podmenit-otvet-cherez-filtr).
...
12. [jabir-sabitov](https://github.com/bitrix-tools/framework-docs/issues?q=is%3Apr+author%3Ajabir-sabitov)